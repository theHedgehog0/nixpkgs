...
- `nodePackages.@tailwindcss/aspect-ratio`, `nodePackages.@tailwindcss/forms`, `nodePackages.@tailwindcss/line-clamp`, and `nodePackages.@tailwindcss/typography`
  have been removed, as they are libraries and should be installed via your preferred JS package manager instead.
